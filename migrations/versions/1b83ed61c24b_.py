"""Add paid_with column to the new schedule order object to enable backwards compatibility

Revision ID: 1b83ed61c24b
Revises: 4e9d87ab5b97
Create Date: 2016-01-30 06:57:47.112867

"""

# revision identifiers, used by Alembic.
revision = '1b83ed61c24b'
down_revision = '4e9d87ab5b97'
...
def upgrade():
    ...
    op.add_column('schedule_order', sa.Column('paid_with', sa.String(length=10), nullable=True))
    ### end Alembic commands ###


def downgrade():
    ### commands auto generated by Alembic - please adjust! ###
    op.drop_column('schedule_order', 'paid_with')
