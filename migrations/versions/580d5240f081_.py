"""Added paid column to enable free-form orders to be created

Revision ID: 580d5240f081
Revises: 1b83ed61c24b
Create Date: 2016-01-30 07:35:06.585889

"""

# revision identifiers, used by Alembic.
revision = '580d5240f081'
down_revision = '1b83ed61c24b'
...
def upgrade():
    ...
    op.add_column('schedule_order', sa.Column('paid', sa.Float(), nullable=True))
    ### end Alembic commands ###


def downgrade():
    ### commands auto generated by Alembic - please adjust! ###
    op.drop_column('schedule_order', 'paid')
