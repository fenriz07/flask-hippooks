"""Add email, first name, last name, and phone to schedule orders
...
revision = '3cc339f1d23'
down_revision = '580d5240f081'
...
def upgrade():
    ...
    op.add_column('schedule_order', sa.Column('email', sa.String(length=75), nullable=True))
    op.add_column('schedule_order', sa.Column('first_name', sa.String(length=255), nullable=True))
    op.add_column('schedule_order', sa.Column('last_name', sa.String(length=255), nullable=True))
    op.add_column('schedule_order', sa.Column('phone', sa.String(length=20), nullable=True))
    ### end Alembic commands ###


def downgrade():
    ### commands auto generated by Alembic - please adjust! ###
    op.drop_column('schedule_order', 'phone')
    op.drop_column('schedule_order', 'last_name')
    op.drop_column('schedule_order', 'first_name')
    op.drop_column('schedule_order', 'email')
